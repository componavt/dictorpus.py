...
# OPTICS Clustering with sklearn.cluster library.
# see https://scikit-learn.org/dev/modules/generated/sklearn.cluster.OPTICS.html
...
# leaf_size=30 or 5, 
optics = cluster.OPTICS(metric='cosine', max_eps=0.2, eps=0.001, min_samples=2, n_jobs=4)
